...
<section class="panel panel-default">
    <header class="panel-heading">
        <h5><i class="glyphicon glyphicon-plus"></i> Tipocandelabros / Crear</h5>
    </header>
    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="{{ route('tipocandelabros.store') }}" method="POST">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">

                    <div class="form-group @if($errors->has('tca_nom')) has-error @endif">
                       <label for="tca_nom-field">Tca_nom</label>
                    <input type="text" id="tca_nom-field" name="tca_nom" class="form-control" value="{{ old("tca_nom") }}" required/>
                    ...
                    <input type="text" id="tca_tip-field" name="tca_tip" class="form-control" value="{{ old("tca_tip") }}" required/>
