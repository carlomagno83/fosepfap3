...
<section class="panel panel-default">
    ...
    <header class="panel-heading">
        <h5><i class="glyphicon glyphicon-edit"></i> Vehiculomodelos / Editar #{{$vehiculomodelo->id}}</h5>
    </header>
    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="{{ route('vehiculomodelos.update', $vehiculomodelo->id) }}" method="POST">
                    <input type="hidden" name="_method" value="PUT">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">

                    <div class="form-group @if($errors->has('vmo_nom')) has-error @endif">
                       <label for="vmo_nom-field">Vmo_nom</label>
                    <input type="text" id="vmo_nom-field" name="vmo_nom" class="form-control" value="{{ $vehiculomodelo->vmo_nom }}" required/>
                    ...
                    <input type="text" id="vehiculomarca_id-field" name="vehiculomarca_id" class="form-control" value="{{ $vehiculomodelo->vehiculomarca_id }}" required/>
