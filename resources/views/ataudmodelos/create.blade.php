...
<section class="panel panel-default">
    <header class="panel-heading">
        <h5><i class="glyphicon glyphicon-plus"></i> Ataudmodelos / Crear</h5>
    </header>
    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="{{ route('ataudmodelos.store') }}" method="POST">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">

                    <div class="form-group @if($errors->has('atm_nom')) has-error @endif">
                       <label for="atm_nom-field">Atm_nom</label>
                    <input type="text" id="atm_nom-field" name="atm_nom" class="form-control" value="{{ old("atm_nom") }}" required/>
