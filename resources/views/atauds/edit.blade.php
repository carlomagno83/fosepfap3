...
<section class="panel panel-default">
    ...
    <header class="panel-heading">
        <h5><i class="glyphicon glyphicon-edit"></i> Atauds / Editar #{{$ataud->id}}</h5>
    </header>
    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="{{ route('atauds.update', $ataud->id) }}" method="POST">
                    <input type="hidden" name="_method" value="PUT">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">

                    <div class="form-group @if($errors->has('ata_tma')) has-error @endif">
                       <label for="ata_tma-field">Ata_tma</label>
                    <input type="text" id="ata_tma-field" name="ata_tma" class="form-control" value="{{ $ataud->ata_tma }}" required/>
                    ...
                    <input type="text" id="ata_pre-field" name="ata_pre" class="form-control" value="{{ $ataud->ata_pre }}" required/>
                    ...
                    <input type="text" id="ata_noc-field" name="ata_noc" class="form-control" value="{{ $ataud->ata_noc }}" required/>
                    ...
                    <input type="text" id="ata_fec-field" name="ata_fec" class="form-control" value="{{ $ataud->ata_fec }}" required/>
                    ...
                    <input type="text" id="proveedor_id-field" name="proveedor_id" class="form-control" value="{{ $ataud->proveedor_id }}" required/>
                    ...
                    <input type="text" id="color_id-field" name="color_id" class="form-control" value="{{ $ataud->color_id }}" required/>
                    ...
                    <input type="text" id="ataudmodelo_id-field" name="ataudmodelo_id" class="form-control" value="{{ $ataud->ataudmodelo_id }}" required/>
                    ...
                    <input type="text" id="ataudtamano_id-field" name="ataudtamano_id" class="form-control" value="{{ $ataud->ataudtamano_id }}" required/>
