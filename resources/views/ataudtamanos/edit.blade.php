...
<section class="panel panel-default">
    ...
    <header class="panel-heading">
        <h5><i class="glyphicon glyphicon-edit"></i> Ataudtamanos / Editar #{{$ataudtamano->id}}</h5>
    </header>
    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="{{ route('ataudtamanos.update', $ataudtamano->id) }}" method="POST">
                    <input type="hidden" name="_method" value="PUT">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">

                    <div class="form-group @if($errors->has('att_nom')) has-error @endif">
                       <label for="att_nom-field">Att_nom</label>
                    <input type="text" id="att_nom-field" name="att_nom" class="form-control" value="{{ $ataudtamano->att_nom }}" required/>
                    ...
                    <input type="text" id="att_dim-field" name="att_dim" class="form-control" value="{{ $ataudtamano->att_dim }}" required/>
