...
<section class="panel panel-default">
    <header class="panel-heading">
        <h5><i class="glyphicon glyphicon-plus"></i> Vehiculos / Crear</h5>
    </header>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="{{ route('vehiculos.store') }}" method="POST">
                    ...
                    <input type="text" id="veh_pla-field" name="veh_pla" class="form-control" value="{{ old("veh_pla") }}" required/>
                    ...
                    <input type="text" id="veh_cla-field" name="veh_cla" class="form-control" value="{{ old("veh_cla") }}" required/>
                    ...
                    <input type="text" id="veh_ser-field" name="veh_ser" class="form-control" value="{{ old("veh_ser") }}" required/>
                    ...
                    <input type="text" id="veh_mot-field" name="veh_mot" class="form-control" value="{{ old("veh_mot") }}" required/>
                    ...
                    <input type="text" id="veh_asi-field" name="veh_asi" class="form-control" value="{{ old("veh_asi") }}" required/>
                    ...
                    <input type="text" id="veh_pas-field" name="veh_pas" class="form-control" value="{{ old("veh_pas") }}" required/>
                    ...
                    <input type="text" id="veh_fra-field" name="veh_fra" class="form-control" value="{{ old("veh_fra") }}" required/>
                    ...
                    <input type="text" id="veh_fr-field" name="veh_fr" class="form-control" value="{{ old("veh_fr") }}" required/>
                    ...
                    <input type="text" id="veh_eje-field" name="veh_eje" class="form-control" value="{{ old("veh_eje") }}" required/>
                    ...
                    <input type="text" id="veh_rue-field" name="veh_rue" class="form-control" value="{{ old("veh_rue") }}" required/>
                    ...
                    <input type="text" id="veh_com-field" name="veh_com" class="form-control" value="{{ old("veh_com") }}" required/>
