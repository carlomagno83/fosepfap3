...
<section class="panel panel-default">
    <header class="panel-heading">
        <h5><i class="glyphicon glyphicon-plus"></i> Capillas / Crear</h5>
    </header>
    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="{{ route('capillas.store') }}" method="POST">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">

                    <div class="form-group @if($errors->has('cap_tip')) has-error @endif">
                       <label for="cap_tip-field">Cap_tip</label>
                    <input type="text" id="cap_tip-field" name="cap_tip" class="form-control" value="{{ old("cap_tip") }}" required/>
                    ...
                    <input type="text" id="cap_mod-field" name="cap_mod" class="form-control" value="{{ old("cap_mod") }}" required/>
                    ...
                    <input type="text" id="cap_txx-field" name="cap_txx" class="form-control" value="{{ old("cap_txx") }}" required/>
                    ...
                    <input type="text" id="cap_ccf-field" name="cap_ccf" class="form-control" value="{{ old("cap_ccf") }}" required/>
                    ...
                    <input type="text" id="cap_fla-field" name="cap_fla" class="form-control" value="{{ old("cap_fla") }}" required/>
                    ...
                    <input type="text" id="cap_man-field" name="cap_man" class="form-control" value="{{ old("cap_man") }}" required/>
                    ...
                    <input type="text" id="cap_alf-field" name="cap_alf" class="form-control" value="{{ old("cap_alf") }}" required/>
                    ...
                    <input type="text" id="cap_cab-field" name="cap_cab" class="form-control" value="{{ old("cap_cab") }}" required/>
                    ...
                    <input type="text" id="cap_cri-field" name="cap_cri" class="form-control" value="{{ old("cap_cri") }}" required/>
                    ...
                    <input type="text" id="cap_tar-field" name="cap_tar" class="form-control" value="{{ old("cap_tar") }}" required/>
                    ...
                    <input type="text" id="cap_rec-field" name="cap_rec" class="form-control" value="{{ old("cap_rec") }}" required/>
                    ...
                    <input type="text" id="cap_plt-field" name="cap_plt" class="form-control" value="{{ old("cap_plt") }}" required/>
                    ...
                    <input type="text" id="cap_mul-field" name="cap_mul" class="form-control" value="{{ old("cap_mul") }}" required/>
