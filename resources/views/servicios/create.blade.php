...
<section class="panel panel-default">
    <header class="panel-heading">
        <h5><i class="glyphicon glyphicon-plus"></i> Servicios / Crear</h5>
    </header>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="{{ route('servicios.store') }}" method="POST">
                    ...
                    <input type="text" id="cas_pfa-field" name="cas_pfa" class="form-control" value="{{ old("cas_pfa") }}" required/>
                    ...
                    <input type="text" id="cas_pat-field" name="cas_pat" class="form-control" value="{{ old("cas_pat") }}" required/>
                    ...
                    <input type="text" id="cas_pac-field" name="cas_pac" class="form-control" value="{{ old("cas_pac") }}" required/>
                    ...
                    <input type="text" id="cas_pne-field" name="cas_pne" class="form-control" value="{{ old("cas_pne") }}" required/>
                    ...
                    <input type="text" id="cas_pru-field" name="cas_pru" class="form-control" value="{{ old("cas_pru") }}" required/>
                    ...
                    <input type="text" id="cas_psc-field" name="cas_psc" class="form-control" value="{{ old("cas_psc") }}" required/>
                    ...
                    <input type="text" id="cas_pta-field" name="cas_pta" class="form-control" value="{{ old("cas_pta") }}" required/>
                    ...
                    <input type="text" id="cas_pvt-field" name="cas_pvt" class="form-control" value="{{ old("cas_pvt") }}" required/>
                    ...
                    <input type="text" id="cas_pvc-field" name="cas_pvc" class="form-control" value="{{ old("cas_pvc") }}" required/>
                    ...
                    <input type="text" id="cas_pvf-field" name="cas_pvf" class="form-control" value="{{ old("cas_pvf") }}" required/>
                    ...
                    <input type="text" id="cas_pva-field" name="cas_pva" class="form-control" value="{{ old("cas_pva") }}" required/>
                    ...
                    <input type="text" id="ataud_id-field" name="ataud_id" class="form-control" value="{{ old("ataud_id") }}" required/>
                    ...
                    <input type="text" id="empleado_id-field" name="empleado_id" class="form-control" value="{{ old("empleado_id") }}" required/>
                    ...
                    <input type="text" id="vehiculo_id-field" name="vehiculo_id" class="form-control" value="{{ old("vehiculo_id") }}" required/>
                    ...
                    <input type="text" id="capilla_id-field" name="capilla_id" class="form-control" value="{{ old("capilla_id") }}" required/>
                    ...
                    <input type="text" id="urna_id-field" name="urna_id" class="form-control" value="{{ old("urna_id") }}" required/>
