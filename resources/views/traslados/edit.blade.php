...
<section class="panel panel-default">
    ...
    <header class="panel-heading">
        <h5><i class="glyphicon glyphicon-edit"></i> Traslados / Editar #{{$traslado->id}}</h5>
    </header>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="{{ route('traslados.update', $traslado->id) }}" method="POST">
                    ...
                    <input type="text" id="tra_fec-field" name="tra_fec" class="form-control" value="{{ $traslado->tra_fec }}" required/>
                    ...
                    <input type="text" id="tra_est-field" name="tra_est" class="form-control" value="{{ $traslado->tra_est }}" required/>
                    ...
                    <input type="text" id="tra_ttr-field" name="tra_ttr" class="form-control" value="{{ $traslado->tra_ttr }}" required/>
                    ...
                    <input type="text" id="tra_cor-field" name="tra_cor" class="form-control" value="{{ $traslado->tra_cor }}" required/>
                    ...
                    <input type="text" id="tra_cde-field" name="tra_cde" class="form-control" value="{{ $traslado->tra_cde }}" required/>
                    ...
                    <input type="text" id="tra_klm-field" name="tra_klm" class="form-control" value="{{ $traslado->tra_klm }}" required/>
                    ...
                    <input type="text" id="tra_fsa-field" name="tra_fsa" class="form-control" value="{{ $traslado->tra_fsa }}" required/>
                    ...
                    <input type="text" id="tra_hsa-field" name="tra_hsa" class="form-control" value="{{ $traslado->tra_hsa }}" required/>
                    ...
                    <input type="text" id="tra_fll-field" name="tra_fll" class="form-control" value="{{ $traslado->tra_fll }}" required/>
                    ...
                    <input type="text" id="tra_hll-field" name="tra_hll" class="form-control" value="{{ $traslado->tra_hll }}" required/>
                    ...
                    <input type="text" id="tra_pre-field" name="tra_pre" class="form-control" value="{{ $traslado->tra_pre }}" required/>
                    ...
                    <input type="text" id="distrito_id-field" name="distrito_id" class="form-control" value="{{ $traslado->distrito_id }}" required/>
                    ...
                    <input type="text" id="cabeceracontrato_id-field" name="cabeceracontrato_id" class="form-control" value="{{ $traslado->cabeceracontrato_id }}" required/>
                    ...
                    <input type="text" id="proveedor_id-field" name="proveedor_id" class="form-control" value="{{ $traslado->proveedor_id }}" required/>
                    ...
                    <div class="well well-sm">
                        ...
                        <a class="btn btn-link pull-right" href="{{ route('traslados.index') }}"><i class="glyphicon glyphicon-backward"></i>  Atrás</a>
                    </div>
                </form>
