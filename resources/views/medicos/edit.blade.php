...
<section class="panel panel-default">
    ...
    <header class="panel-heading">
        <h5><i class="glyphicon glyphicon-edit"></i> Medicos / Editar #{{$medico->id}}</h5>
    </header>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="{{ route('medicos.update', $medico->id) }}" method="POST">
                    ...
                    <input type="text" id="med_dni-field" name="med_dni" class="form-control" value="{{ $medico->med_dni }}" required/>
                    ...
                    <input type="text" id="med_pat-field" name="med_pat" class="form-control" value="{{ $medico->med_pat }}" required/>
                    ...
                    <input type="text" id="med_mat-field" name="med_mat" class="form-control" value="{{ $medico->med_mat }}" required/>
                    ...
                    <input type="text" id="med_nom-field" name="med_nom" class="form-control" value="{{ $medico->med_nom }}" required/>
                    ...
                    <input type="text" id="med_col-field" name="med_col" class="form-control" value="{{ $medico->med_col }}" required/>
                    ...
                    <input type="text" id="med_dir-field" name="med_dir" class="form-control" value="{{ $medico->med_dir }}" required/>
                    ...
                    <input type="text" id="med_ubi-field" name="med_ubi" class="form-control" value="{{ $medico->med_ubi }}" required/>
                    ...
                    <input type="text" id="distrito_id-field" name="distrito_id" class="form-control" value="{{ $medico->distrito_id }}" required/>
