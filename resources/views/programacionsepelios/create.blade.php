...
@section('content')
    ...
    <div class="panel-body">
        <div class="row">
            ...
            <form action="{{ route('programacionsepelios.store') }}" method="POST">
            ...
            <div class="col-md-3">
                    ...
                    <input type="text" id="prs_fec-field" name="prs_fec" class="form-control" value="{{ old("prs_fec") }}" required/>
                    ...
                    <input type="text" id="prs_dni-field" name="prs_dni" class="form-control" value="{{ old("prs_dni") }}" required/>
                    ...
                    <input type="text" id="prs_pat-field" name="prs_pat" class="form-control" value="{{ old("prs_pat") }}" required/>
                    ...
                    <input type="text" id="prs_mat-field" name="prs_mat" class="form-control" value="{{ old("prs_mat") }}" required/>
                    ...
                    <input type="text" id="prs_nom-field" name="prs_nom" class="form-control" value="{{ old("prs_nom") }}" required/>
            ...
            <div class="col-md-3">
                <div class="form-group @if($errors->has('prs_vel')) has-error @endif">
                    ...
                    <input type="text" id="prs_vel-field" name="prs_vel" class="form-control" value="{{ old("prs_vel") }}" required/>
                ...
                <div class="form-group @if($errors->has('prs_cem')) has-error @endif">
                    ...
                    <input type="text" id="prs_cem-field" name="prs_cem" class="form-control" value="{{ old("prs_cem") }}" required/>
                ...
                <div class="form-group @if($errors->has('prs_vca')) has-error @endif">
                    ...
                    <input type="text" id="prs_vca-field" name="prs_vca" class="form-control" value="{{ old("prs_vca") }}" required/>
                ...
                <div class="form-group @if($errors->has('prs_chc')) has-error @endif">
                    ...
                    <input type="text" id="prs_chc-field" name="prs_chc" class="form-control" value="{{ old("prs_chc") }}" required/>
                ...
                <div class="form-group @if($errors->has('prs_vfl')) has-error @endif">
                    ...
                    <input type="text" id="prs_vfl-field" name="prs_vfl" class="form-control" value="{{ old("prs_vfl") }}" required/>
            ...
            <div class="col-md-3">
                <div class="form-group @if($errors->has('prs_cfl')) has-error @endif">
                    ...
                    <input type="text" id="prs_cfl-field" name="prs_cfl" class="form-control" value="{{ old("prs_cfl") }}" required/>
                ...
                <div class="form-group @if($errors->has('prs_vac')) has-error @endif">
                    ...
                    <input type="text" id="prs_vac-field" name="prs_vac" class="form-control" value="{{ old("prs_vac") }}" required/>
                ...
                <div class="form-group @if($errors->has('prs_cac')) has-error @endif">
                    ...
                    <input type="text" id="prs_cac-field" name="prs_cac" class="form-control" value="{{ old("prs_cac") }}" required/>
                ...
                <div class="form-group @if($errors->has('prs_hsf')) has-error @endif">
                    ...
                    <input type="text" id="prs_hsf-field" name="prs_hsf" class="form-control" value="{{ old("prs_hsf") }}" required/>
                ...
                <div class="form-group @if($errors->has('prs_hsv')) has-error @endif">
                    ...
                    <input type="text" id="prs_hsv-field" name="prs_hsv" class="form-control" value="{{ old("prs_hsv") }}" required/>
            ...
            <div class="col-md-3">
                <div class="form-group @if($errors->has('prs_hic')) has-error @endif">
                    ...
                    <input type="text" id="prs_hic-field" name="prs_hic" class="form-control" value="{{ old("prs_hic") }}" required/>
                ...
                <div class="form-group @if($errors->has('prs_dfu')) has-error @endif">
                    ...
                    <input type="text" id="prs_dfu-field" name="prs_dfu" class="form-control" value="{{ old("prs_dfu") }}" required/>
                ...
                <div class="form-group @if($errors->has('id')) has-error @endif">
                    ...
                    <input type="text" id="id-field" name="id" class="form-control" value="{{ old("id") }}" required/>
                    @if($errors->has("id"))
