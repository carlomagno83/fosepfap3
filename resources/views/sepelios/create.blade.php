...
<section class="panel panel-default">
    <header class="panel-heading">
        <h5><i class="glyphicon glyphicon-plus"></i> Sepelios / Crear</h5>
    </header>
    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="{{ route('sepelios.store') }}" method="POST">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">

                    <div class="form-group @if($errors->has('cem_fse')) has-error @endif">
                       <label for="cem_fse-field">Cem_fse</label>
                    <input type="text" id="cem_fse-field" name="cem_fse" class="form-control" value="{{ old("cem_fse") }}" required/>
                    ...
                    <input type="text" id="cem_hsf-field" name="cem_hsf" class="form-control" value="{{ old("cem_hsf") }}" required/>
                    ...
                    <input type="text" id="cem_hsv-field" name="cem_hsv" class="form-control" value="{{ old("cem_hsv") }}" required/>
                    ...
                    <input type="text" id="cem_hic-field" name="cem_hic" class="form-control" value="{{ old("cem_hic") }}" required/>
                    ...
                    <input type="text" id="cem_tse-field" name="cem_tse" class="form-control" value="{{ old("cem_tse") }}" required/>
                    ...
                    <input type="text" id="cem_tip-field" name="cem_tip" class="form-control" value="{{ old("cem_tip") }}" required/>
                    ...
                    <input type="text" id="cem_sep-field" name="cem_sep" class="form-control" value="{{ old("cem_sep") }}" required/>
                    ...
                    <input type="text" id="cem_nco-field" name="cem_nco" class="form-control" value="{{ old("cem_nco") }}" required/>
                    ...
                    <input type="text" id="cem_oco-field" name="cem_oco" class="form-control" value="{{ old("cem_oco") }}" required/>
                    ...
                    <input type="text" id="cem_fec-field" name="cem_fec" class="form-control" value="{{ old("cem_fec") }}" required/>
                    ...
                    <input type="text" id="cem_pre-field" name="cem_pre" class="form-control" value="{{ old("cem_pre") }}" required/>
