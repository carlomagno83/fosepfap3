        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('proveedors.store') }}" method="POST">
                ...
                <div class="form-group @if($errors->has('ruc')) has-error @endif">
                    ...
                    <input type="text" id="ruc-field" name="ruc" class="form-control" value="{{ old("ruc") }}"/>
                       @if($errors->has("ruc"))
                    ...
                    <input type="text" id="direccion-field" name="direccion" class="form-control" value="{{ old("direccion") }}"/>
                    ...
                    <input type="text" id="iddistrito-field" name="iddistrito" class="form-control" value="{{ old("iddistrito") }}"/>
                    ...
                    <input type="text" id="telefono_fijo-field" name="telefono_fijo" class="form-control" value="{{ old("telefono_fijo") }}"/>
                    ...
                    <input type="text" id="telefono_celular-field" name="telefono_celular" class="form-control" value="{{ old("telefono_celular") }}"/>
                    ...
                    <input type="text" id="costo-field" name="costo" class="form-control" value="{{ old("costo") }}"/>
                       @if($errors->has("costo"))
                    ...
                    <textarea class="form-control" id="observacion-field" rows="3" name="observacion">{{ old("observacion") }}</textarea>
                    ...
                    <input type="text" id="id_categoria-field" name="id_categoria" class="form-control" value="{{ old("id_categoria") }}"/>
