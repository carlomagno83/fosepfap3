...
<section class="panel panel-default">
    <header class="panel-heading">
        <h5><i class="glyphicon glyphicon-plus"></i> Proveedors / Crear</h5>
    </header>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="{{ route('proveedors.store') }}" method="POST">
                    ...
                    <input type="text" id="pro_ruc-field" name="pro_ruc" class="form-control" value="{{ old("pro_ruc") }}" required/>
                    ...
                    <input type="text" id="pro_rso-field" name="pro_rso" class="form-control" value="{{ old("pro_rso") }}" required/>
                    ...
                    <input type="text" id="pro_dir-field" name="pro_dir" class="form-control" value="{{ old("pro_dir") }}" required/>
                    ...
                    <input type="text" id="pro_fij-field" name="pro_fij" class="form-control" value="{{ old("pro_fij") }}" required/>
                    ...
                    <input type="text" id="pro_cel-field" name="pro_cel" class="form-control" value="{{ old("pro_cel") }}" required/>
                    ...
                    <input type="text" id="pro_mai-field" name="pro_mai" class="form-control" value="{{ old("pro_mai") }}" required/>
                    ...
                    <input type="text" id="pro_obs-field" name="pro_obs" class="form-control" value="{{ old("pro_obs") }}" required/>
                    ...
                    <div class="form-group @if($errors->has('categoria_id')) has-error @endif">
                       <label for="categoria_id-field">Categoria_id</label>
                        {{Form::select('categoria_id', \App\Categorium::pluck('cat_nom','id') ,null, ['placeholder' => 'Seleccione Categoría','id'=>'categoria_id-field','class'=>'form-control','required'=>''])}}
