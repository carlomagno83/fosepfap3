    ...
    <div class="panel-body">
        ...
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
            ...
            <div class="col-md-4">
                    ...
                    <input type="text" id="con_fec-field" name="con_fec" class="form-control" value="{{ old("con_fec") }}" required/>
                    ...
                    <input type="text" id="con_est-field" name="con_est" class="form-control" value="{{ old("con_est") }}" required/>
                    ...
                    <input type="text" id="sepelio_id-field" name="sepelio_id" class="form-control" value="{{ old("sepelio_id") }}" required/>
                    ...
                    <input type="text" id="fallecido_id-field" name="fallecido_id" class="form-control" value="{{ old("fallecido_id") }}" required/>
                    ...
                    <input type="text" id="servicio_id-field" name="servicio_id" class="form-control" value="{{ old("servicio_id") }}" required/>
