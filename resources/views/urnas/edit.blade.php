...
<section class="panel panel-default">
    ...
    <header class="panel-heading">
        <h5><i class="glyphicon glyphicon-edit"></i> Urnas / Editar #{{$urna->id}}</h5>
    </header>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="{{ route('urnas.update', $urna->id) }}" method="POST">
                    ...
                    <input type="text" id="urn_tip-field" name="urn_tip" class="form-control" value="{{ $urna->urn_tip }}" required/>
                    ...
                    <input type="text" id="urn_mod-field" name="urn_mod" class="form-control" value="{{ $urna->urn_mod }}" required/>
                    ...
                    <input type="text" id="urn_col-field" name="urn_col" class="form-control" value="{{ $urna->urn_col }}" required/>
                    ...
                    <input type="text" id="urn_pre-field" name="urn_pre" class="form-control" value="{{ $urna->urn_pre }}" required/>
                    ...
                    <input type="text" id="proveedor_id-field" name="proveedor_id" class="form-control" value="{{ $urna->proveedor_id }}" required/>
