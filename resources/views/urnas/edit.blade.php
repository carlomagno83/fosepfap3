...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-edit"></i> Urnas / Edit #{{$urna->id}}</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('urnas.update', $urna->id) }}" method="POST">
                <input type="hidden" name="_method" value="PUT">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">

                <div class="form-group @if($errors->has('urn_id')) has-error @endif">
                       <label for="urn_id-field">Urn_id</label>
                    <input type="text" id="urn_id-field" name="urn_id" class="form-control" value="{{ $urna->urn_id }}"/>
                    ...
                    <input type="text" id="urn_tip-field" name="urn_tip" class="form-control" value="{{ $urna->urn_tip }}"/>
                    ...
                    <input type="text" id="urn_mod-field" name="urn_mod" class="form-control" value="{{ $urna->urn_mod }}"/>
                    ...
                    <input type="text" id="urn_col-field" name="urn_col" class="form-control" value="{{ $urna->urn_col }}"/>
                    ...
                    <input type="text" id="urn_pre-field" name="urn_pre" class="form-control" value="{{ $urna->urn_pre }}"/>
                    ...
                    <input type="text" id="servicio_id-field" name="servicio_id" class="form-control" value="{{ $urna->servicio_id }}"/>
                    ...
                    <input type="text" id="proveedor_id-field" name="proveedor_id" class="form-control" value="{{ $urna->proveedor_id }}"/>
